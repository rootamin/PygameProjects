...
class FireAnimation(pygame.sprite.Sprite):
    def __init__(self, entity, surf_list, direction, groups):
        ...
        if direction.x < 0:
            self.frames = [pygame.transform.flip(frame, True, False) for frame in self.frames] # fuck single line methods
    ...
    def move(self): # moves the fire animation with the player movement
