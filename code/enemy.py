...
class Enemy(Entity):
    def __init__(self, pos, path, groups, shoot, player, collision_sprites):
        ...
        self.player = player
        for sprite in collision_sprites.sprites(): # practice this sprite for loop more often
    ...
    def check_fire(self):
        ...
        same_y = True if self.rect.top - 20 < player_pos.y < self.rect.bottom + 20 else False # 137 16:00
